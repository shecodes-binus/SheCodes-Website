...
export function SuccessStoriesCarousel({
  ...
  return (
    <section className="w-full py-12 md:py-16 lg:py-20 bg-purple-2 overflow-hidden relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Gradient Overlays */}
          <div aria-hidden="true" className="absolute inset-y-0 left-0 w-16 sm:w-24 md:w-32 bg-gradient-to-r from-purple-2 to-transparent z-10 pointer-events-none"></div>
          <div aria-hidden="true" className="absolute inset-y-0 right-0 w-16 sm:w-24 md:w-32 bg-gradient-to-l from-purple-2 to-transparent z-10 pointer-events-none"></div>
